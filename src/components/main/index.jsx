  ...
  return(
    <>
      <section class='text-gray-50 bg-no-repeat bg-cover'style={backgroundImageStyle}>
        <div class='pt-24 flex justify-center items-center flex-col p-4 h-full w-full bg-black bg-opacity-60'>
                  <img class="shadow-black shadow-xl p-3 rounded-full h-80 w-80" src={profile} alt="profile-image"/>
          <div class='flex flex-col items-center'>
            <p class=' my-4 text-4xl'>Luan Tavares</p>
            <div class='flex gap-5 justify-center my-6'>
          ...
          <div class=' my-1 flex justify-center gap-4 rounded-full bg-black  shadow-2xl shadow-black'>
